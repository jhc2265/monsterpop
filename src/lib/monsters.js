export const MONSTERS = [
  ...
  { id: 'mimic', name: '황금 미믹', grade: '특수', score: 100, weight: 3, hp: 1, speed: '매우 빠름', gesture: 'double-tap', cue: '×2', hint: '빠르게 두 번', reward: 'burst', noEscapePenalty: true, escapeDuration: 2200, image: '/images/monsters/mimic.webp', color: '#ffd45b', emoji: '▣', description: '아주 잠깐 모습을 드러내는 보물 몬스터. 처치하면 섀도우 버스트가 즉시 충전됩니다.' },
